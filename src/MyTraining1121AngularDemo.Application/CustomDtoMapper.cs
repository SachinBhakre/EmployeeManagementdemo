...
using MyTraining1121AngularDemo.CustomerUserModels;
...
namespace MyTraining1121AngularDemo
{
    internal static class CustomDtoMapper
    {
        ...
        {
            configuration.CreateMap<CreateOrEditCustomerUserModelDto, CustomerUserModel>().ReverseMap();
            configuration.CreateMap<CustomerUserModelDto, CustomerUserModel>().ReverseMap();
            configuration.CreateMap<CreateOrEditUserModelDto, UserModel>().ReverseMap();
            configuration.CreateMap<UserModelDto, UserModel>().ReverseMap();
