...
namespace MyTraining1121AngularDemo.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            var customerUserModels = pages.CreateChildPermission(AppPermissions.Pages_CustomerUserModels, L("CustomerUserModels"));
            customerUserModels.CreateChildPermission(AppPermissions.Pages_CustomerUserModels_Create, L("CreateNewCustomerUserModel"));
            customerUserModels.CreateChildPermission(AppPermissions.Pages_CustomerUserModels_Edit, L("EditCustomerUserModel"));
            customerUserModels.CreateChildPermission(AppPermissions.Pages_CustomerUserModels_Delete, L("DeleteCustomerUserModel"));

            var userModels = pages.CreateChildPermission(AppPermissions.Pages_UserModels, L("UserModels"));
            userModels.CreateChildPermission(AppPermissions.Pages_UserModels_Create, L("CreateNewUserModel"));
            userModels.CreateChildPermission(AppPermissions.Pages_UserModels_Edit, L("EditUserModel"));
            userModels.CreateChildPermission(AppPermissions.Pages_UserModels_Delete, L("DeleteUserModel"));
