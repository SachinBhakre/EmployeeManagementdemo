namespace MyTraining1121AngularDemo.Authorization
{
    ...
    {
        public const string Pages_CustomerUserModels = "Pages.CustomerUserModels";
        public const string Pages_CustomerUserModels_Create = "Pages.CustomerUserModels.Create";
        public const string Pages_CustomerUserModels_Edit = "Pages.CustomerUserModels.Edit";
        public const string Pages_CustomerUserModels_Delete = "Pages.CustomerUserModels.Delete";

        public const string Pages_UserModels = "Pages.UserModels";
        public const string Pages_UserModels_Create = "Pages.UserModels.Create";
        public const string Pages_UserModels_Edit = "Pages.UserModels.Edit";
        public const string Pages_UserModels_Delete = "Pages.UserModels.Delete";
